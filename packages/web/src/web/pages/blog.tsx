        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-6 text-sm text-gray-500">
              ...
              <a href="/aviso-legal" className="hover:text-[#10b981] transition-colors">Aviso Legal</a><a href="/cookies" className="hover:text-[#10b981] transition-colors">Cookies</a><a href="/cookies" className="hover:text-[#10b981] transition-colors">Cookies</a>
            </div>
